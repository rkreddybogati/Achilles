 ...
 *
 *   Future<Empty> emptyFuture = asyncBatch.flushBatch(); // send the INSERT statement to Cassandra
 *
 * </code></pre>
 *
...
public class AsyncBatch extends CommonBatch {
     ...
     *
     */
    public AchillesFuture<Empty> flushBatch(FutureCallback<Object>... asyncListeners) {
        log.debug("Flushing batch asynchronously");
        try {
