...
public class PersistenceManagerFacadeTest {
    ...
    public void should_persist() throws Exception {
        ...
        when(asyncUtils.transformFuture(eq(futureResultSets), resultSetsToEntityCaptor.capture())).thenReturn(futureEntity);
    ...
    public void should_remove() throws Exception {
        ...
        //When
        final AchillesFuture<CompleteBean> actual = facade.remove();
