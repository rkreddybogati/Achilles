...
public class BatchTest {
    ...
    public void should_exception_when_persist_with_consistency() throws Exception {
        ...
        exception.expectMessage("Runtime custom Consistency Level and/or async listeners cannot be set for batch mode. Please set the Consistency Levels at batch start with 'startBatch(consistencyLevel)' and async listener using flushBatch(...)");
    ...
    public void should_exception_when_remove_with_consistency() throws Exception {
        ...
        batch.remove(new CompleteBean(), withConsistency(ONE));
    }
