...
public class AsyncOperationsIT {
    ...
    public void should_remove_many() throws Exception {
        ...
        final AchillesFuture<CompleteBean> futurePaul = manager.remove(paul, withAsyncListeners(successCallBack));
        final AchillesFuture<CompleteBean> futureJack = manager.remove(jack);
        final AchillesFuture<CompleteBean> futureJohn = manager.remove(john);
